...
def test_normalize_continuum():
    ...
    qafileinfo = {"filepath": qa_path, "filename": "RV", "extension": ".png"}
    normalize_continuum(
        wavelength, flux, np.array([0.98, 0.995, 1.02, 1.04]), 4, qa_fileinfo=qafileinfo
    )

    png_files = glob.glob(join(qa_path, "RV.png"))
